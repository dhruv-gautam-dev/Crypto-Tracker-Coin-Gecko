...
function Navbar() {
  // const { setCurrency } = useContext(CurrencyContext);   // access setCurrency by using context api
  const { setCurrency } = currencyStore(); // access setCurrency by using zustand
